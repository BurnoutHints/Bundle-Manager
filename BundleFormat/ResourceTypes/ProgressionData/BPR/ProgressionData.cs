...
namespace BundleFormat.ResourceTypes.ProgressionData.BPR;
...
internal class ProgressionData : ISerializableResourceType
{
	...
	internal ArrayPointer<BP_19.EventJunction> eventJunctions = new();
	...
	internal ArrayPointer<BP_19.Rival> rivals = new();
	...
	internal uint mainlandJunctionCount;
	...
	public CollectionDescriptor<BP_19.EventJunction> EventJunctions { get => eventJunctions.Data!; }
	...
	public CollectionDescriptor<BP_19.Rival> Rivals { get => rivals.Data!; }
	...
	[Tooltip("Mainland junction count.\nThis is used for savegame validation (against BrnProgression::Profile::miEventCount).")]
	public uint MainlandJunctionCount { get => mainlandJunctionCount; set => mainlandJunctionCount = value; }
	...
	private void UpdatePointers(bool is64Bit, out ulong position)
	{
		...
		Serializer.UpdateArrayAddress(ref currentPosition, eventJunctions, typeof(BP_19.EventJunction), is64Bit, eventJunctionCount);
		Serializer.UpdateArrayAddress(ref currentPosition, events, typeof(BP_19.RaceEventData), is64Bit, eventCount);
		Serializer.UpdateArrayAddress(ref currentPosition, rivals, typeof(BP_19.Rival), is64Bit, (ulong)rivalCount);
		...
		ulong raceEventDataLength = Serializer.StructureSizes.GetValueOrDefault(new(typeof(BP_19.RaceEventData), is64Bit));
	...
	private void UpdateJunctionPointer(InstancePointer<BP_19.RaceEventData> eventPointer, ulong raceEventDataLength)
	{
	...
	private void UpdateCheckpointPointers(ref ulong currentPosition, ulong checkpointDataLength)
	{
		foreach (var eventData in events.Data!.Collection)
		{
			...
			currentPosition = Serializer.Align(currentPosition, 0x10);
		}
	}

	private void UpdateCheckpointPointer(BP_19.RaceEventData eventData, ref ulong currentPosition, ulong checkpointDataLength)
	{
